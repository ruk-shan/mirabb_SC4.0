...
class FollowJointTrajectoryServer:
    def __init__(self):
        ...
        self.action_server = actionlib.SimpleActionServer("/mirabb/abb_arm_controller/follow_joint_trajectory", FollowJointTrajectoryAction, self.goal_callback, False)
...
if __name__ == "__main__":
    rospy.init_node("abb_follow_joint_trajectory_server")
